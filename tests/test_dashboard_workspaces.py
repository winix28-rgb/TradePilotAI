...
def test_dashboard_workspace_modules_export_renderers():
    ...
    assert callable(render_performance_workspace)
    assert callable(render_paper_trading_workspace)
    assert callable(render_trade_journal_workspace)
    ...
    assert callable(render_system_status_workspace)
    assert callable(render_validation_workspace)
