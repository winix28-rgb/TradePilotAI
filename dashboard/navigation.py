...
class NavigationManager:
    ...
    def __init__(self):
        ...
        self.items: list[NavigationItem] = [
            ...
            NavigationItem("validation", "Validation", "✅"),
            NavigationItem("system_status", "System Status", "🩺"),
            NavigationItem("paper_trading", "Paper Trading", "💷"),
            NavigationItem("trade_journal", "Trade Journal", "📒"),
